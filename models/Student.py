...
class Student(db.Model):
    ...
    gender = db.Column('std_gender', db.String(3), nullable=False)
    ethnicity = db.Column('std_ethnicity', db.String(5), nullable=False)
    ...
    city = db.Column('std_city', db.Integer, nullable=False)
    district = db.Column('std_district', db.Integer, nullable=False)
