...
class ALStudent(db.Model):
    ...
    student_id = db.Column('std_al_student_id', db.Integer, db.ForeignKey('tbl_students.id'), unique=True, nullable=False)
    ...
    stream = db.Column('std_al_stream', db.String(50), unique=True, nullable=False)
    al_index_no = db.Column('std_al_index', db.String(50), nullable=False)
    z_score = db.Column('std_al_z_score', db.String(20), nullable=False)
